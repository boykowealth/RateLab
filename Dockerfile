...
RUN R -e "install.packages(c('devtools', 'dplyr', 'tidyverse', 'rlang', 'utils', 'stringr', 'lubridate', 'shiny', 'bslib', 'DT', 'ggplot2', 'rcpp', 'tidyquant'), dependencies = TRUE, repos = 'https://packagemanager.rstudio.com/cran/latest')"
